...
function executeRecaptcha(action) {
    try {
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('6LeHfuwrAAAAAE-FOdiuq6iB9Wdbh5VRbWGBlwxK', {
                action: action
            }).then(function(token) {
...
function onClick(e) {
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('6LeHfuwrAAAAAE-FOdiuq6iB9Wdbh5VRbWGBlwxK', {
            ...
            console.log('Token de LOGIN generado: ' + token.substring(0, 50) + '...');
        });
    });
}
...
console.log('   - THEME_TOGGLE: Al cambiar el tema');
